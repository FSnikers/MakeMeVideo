...
public class ChatGptPageInteractor : IChatGptPageInteractor
{
    private readonly IBrowserDriverFactory _driverFactory;
    private readonly ILogger<ChatGptPageInteractor> _logger;
    ...
    public ChatGptPageInteractor(
        IBrowserDriverFactory driverFactory,
        ILogger<ChatGptPageInteractor> logger)
    {
