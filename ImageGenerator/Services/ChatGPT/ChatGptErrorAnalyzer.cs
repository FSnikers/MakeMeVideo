...
public class ChatGptErrorAnalyzer : IChatGptErrorAnalyzer
{
    private readonly ILogger<ChatGptErrorAnalyzer> _logger;
    ...
    public ChatGptErrorAnalyzer(ILogger<ChatGptErrorAnalyzer> logger)
    {
        _logger = logger;
    }
