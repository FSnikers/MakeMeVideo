...
public class ChatGptImageExtractorHelperModule : IChatGptImageExtractorHelperModule
{
    private readonly IBrowserDriverFactory _driverFactory;
    private readonly ILogger<ChatGptImageExtractorHelperModule> _logger;
    ...
    public ChatGptImageExtractorHelperModule(
        IBrowserDriverFactory driverFactory,
        ILogger<ChatGptImageExtractorHelperModule> logger,
